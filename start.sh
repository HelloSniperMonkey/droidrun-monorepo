...
pm2 delete gateway job-hunter web mirror-service 2>/dev/null || true
...
pm2 start "npm run start:webrtc" \
	--name mirror-service \
    --cwd /Users/soumyayotimohanta/Developer/hackathon/monorepo/apps/mirror-service
